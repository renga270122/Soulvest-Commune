...
function buildStaffSummary(staffAttendance) {
...
function createPromptContext(mcpContext, routing) {
  ...
  return [
    ...
    `Actor: ${actor.name} (${actor.role}) flat=${actor.flat || 'n/a'} society=${actor.societyId} language=${actor.language}`,
